...
function MakePlace(Word: string): NodePtr; // Поиск места для вставки нового узла 
...
procedure ProcessLine(Line: string); // Обработка и разбитие строки, и обновление списка 
var Word: string;
  i, WordStart: Integer;
begin
  Line:=Line+' ';
